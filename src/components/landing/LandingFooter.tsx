      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-2xl font-bold text-white">ParcelTrack</span>
            </div>
            <p className="text-gray-400 mb-6 max-w-sm">
              Modern parcel management system for universities, condominiums, and corporate offices. 
              Track, manage, and deliver parcels efficiently.
            </p>
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm">
            © {currentYear} ParcelTrack. All rights reserved.
          </p>
